    ...
    $(function() {
        $("#secondForm").phTable({
            ...
            validationInputValues: {
                ...
                Capital: { regex: '^[0-9]+$', description: 'Only a number', nullAble: true},
                Code_2: { regex: '^[A-Za-z]{2}$', description: 'Two letters', nullAble: false},
                Head_of_state: {regex: '^[A-Za-z ]+$', description: 'Only letters and spaces', nullAble: true},

                Life_expectancy: {regex: '^[0-9]+(\.[0-9]{1})?$', description: 'Only a number with a maximum of 1 deciamls', nullAble: true},
