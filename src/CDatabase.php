...
/**
  ...
  public function ExecuteSelectQueryAndFetchAll($query, $params=array(), $debug=false) {
    ...
    /*
    public function ExecuteSelectQueryAndFetchAllFilmDbShowAll($query, $title, $year1, $year2, $genre, $debug=false) {
    ...
    $this->stmt->bindValue(':year1', $year1, PDO::PARAM_INT);
    $this->stmt->bindValue(':year2', $year2, PDO::PARAM_INT);

    $this->stmt->bindValue(':genre', $genre, PDO::PARAM_STR);
